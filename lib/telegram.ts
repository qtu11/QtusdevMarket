...
🏦 <b>Ngân hàng:</b> ${depositInfo.method}
📝 <b>Mã giao dịch:</b> ${depositInfo.transactionId}
🏦 <b>Tên chủ TK:</b> ${depositInfo.accountName || 'N/A'}
🔢 <b>Số TK:</b> ${depositInfo.accountNumber || 'N/A'}
🌐 <b>IP:</b> ${depositInfo.ipAddress || 'Unknown'}
📱 <b>Thiết bị:</b> ${depositInfo.deviceInfo?.deviceType || 'Unknown'} (${depositInfo.deviceInfo?.browser || 'Unknown'})
